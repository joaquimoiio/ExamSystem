...
const difficultyConfig = {
  easy: { label: 'Fácil', color: 'bg-green-100 text-green-800 dark:bg-green-800/20 dark:text-green-300' },
  medium: { label: 'Médio', color: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-800/20 dark:text-yellow-300' },
  hard: { label: 'Difícil', color: 'bg-red-100 text-red-800 dark:bg-red-800/20 dark:text-red-300' }
};
            ...
            {filteredQuestions.length > 0 ? (
              filteredQuestions.map(question => {
                ...
                return (
                  <div
                    key={question.id}
                    className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-500 transition-colors"
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="px-2 py-1 bg-blue-100 text-blue-800 dark:bg-blue-800/20 dark:text-blue-300 text-xs font-medium rounded">
                          {question.points || 1} pts
                        </span>
                      </div>
                      <button
                        onClick={() => addQuestion(question)}
                        className="p-1 text-green-600 hover:text-green-700 hover:bg-green-50 dark:hover:bg-green-800/20 rounded transition-colors"
                ...
                return (
                  ...
                  >
                      ...
                      <div className="flex items-center space-x-1">
                        <div className="flex flex-col space-y-1">
                          <button
                            ...
                            disabled={index === 0}
                            className="p-1 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 disabled:opacity-30 transition-colors"
                        ...
                        <button
                          ...
                          className="p-1 text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-800/20 rounded transition-colors ml-2"
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        <label className="text-xs text-gray-600 dark:text-gray-400">Pontos:</label>
                        <input
                          type="number"
                          min="0.1"
                          step="0.1"
                          ...
                          className="w-16 px-2 py-1 text-xs border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                        />
                      </div>
                    </div>
                  </div>
